...
export function useAppShellController() {
  ...
  return {
    ...
    fileOpsCopy,
    encodingActionLabel: editorChromeCopy.encodingActionLabel,
    encodingActionPlaceholder: editorChromeCopy.encodingActionPlaceholder,
    encodingChipTitle: editorChromeCopy.encodingChipTitle,
    encodingLabel: editorChromeCopy.encoding,
    encodingReopenBlocked: editorChromeCopy.encodingReopenBlocked,
    encodingReopenGroup: editorChromeCopy.encodingReopenGroup,
    encodingSaveGroup: editorChromeCopy.encodingSaveGroup,
    findInputRef,
    findMatchCount,
    findMatches,
    findQuery,
