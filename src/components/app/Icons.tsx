...
export function PanelLeftCloseIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M4.8 6L3.5 8L4.8 10" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function PanelLeftOpenIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="2" y="2.5" width="12" height="11" rx="1.4" stroke="currentColor" strokeWidth="1.2"/>
      <path d="M6 2.5V13.5" stroke="currentColor" strokeWidth="1.2"/>
      <path d="M3.5 6L4.8 8L3.5 10" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function CopyIcon() {
  return (
    <svg width="13" height="13" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M3 11V5C3 3.89543 3.89543 3 5 3H9" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
    </svg>
  );
}
...
export function AgentWindowIcon() {
  return (
    ...
    >
      <rect x="1.5" y="2.5" width="11" height="9" rx="1.2" stroke="currentColor" strokeWidth="1.3" />
      <path d="M4 6L5.5 7L4 8" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M6.5 8.5H8.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
      <path d="M5 11.5L7 13L9 11.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
