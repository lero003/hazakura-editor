...
This policy describes the current App Store preview lane for hazakura editor. It focuses on the app's own behavior. It does not describe what macOS, Apple services, or files opened in other apps may do.

## Overview

hazakura editor is a local Markdown and text editor. The app is designed to open, edit, preview, compare, and save files that you choose.

## Files you choose

The app reads and writes files or folders you select through the app UI. It does not scan your home directory automatically, does not index a project in the background, and does not upload document contents.
...
For support or privacy questions, use the support contact listed in the App Store product page or the project repository. Include only the information you choose to share.
