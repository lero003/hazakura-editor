  ...
  return (
    <div data-review-request-id={proposal.requestId} aria-label={copy.regionLabel} aria-busy={applying || !!proposal.streaming}
      ...
      {proposal.streaming ? <p role="status">{copy.busy}</p> : <>
        <p className="local-assist-proposal-review-summary">{copy.model}: {proposal.generation?.modelId === "apple:foundation-models:system-default"
          ? "Apple Intelligence" : proposal.generation?.modelId === "fixture:helper-v0.12" ? copy.fixtureModel : copy.unknownModel}</p>
