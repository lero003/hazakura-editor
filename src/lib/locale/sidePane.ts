...
export function getSidePaneCopy(lang: MenuLanguage): SidePaneCopy {
  if (isKanaStyle(lang)) {
    return {
      ...
      appleAssistUnavailableSession: "Apple Intelligence の もでるは つかえません",
  ...
  return isJapaneseMenuLanguage(lang)
    ? {
        ...
        appleAssistUnavailableSession: "Apple Intelligenceモデルは利用できません",
    ...
    : {
        ...
        appleAssistUnavailableSession: "Apple Intelligence model unavailable",
