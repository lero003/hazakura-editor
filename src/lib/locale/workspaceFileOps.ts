...
export function getWorkspaceFileOpsCopy(
  ...
  if (isKanaStyle(lang)) {
    return {
      ...
      newOkfScaffoldBookLikeHint:
        "index.md・chapters/ よっつ・全体こうせい・人物・せってい・log.md。章だては れい。",
  ...
  return isJapaneseMenuLanguage(lang)
    ? {
        ...
        newOkfScaffoldBookLikeHint:
          "index.md・chapters/ 4本・全体構成・人物・設定・log.md。章立ては例示です。",
    ...
    : {
        ...
        newOkfScaffoldBookLikeHint:
          "index.md, four chapters, overview, characters, setting, and log.md — an illustrative layout.",
