...
export function getLModeCopy(lang: MenuLanguage): LModeCopy {
  if (isKanaStyle(lang)) {
    return {
      ...
      statusBarAppleAssistTitle: "Apple Assist の ウィンドウを ひらく / かくす",
  ...
  return isJapaneseMenuLanguage(lang)
    ? {
        ...
        statusBarAppleAssistLabel: "Apple Assist",
        statusBarAppleAssistTitle: "Apple Assist ウィンドウを表示 / 非表示",
    ...
    : {
        ...
        statusBarAppleAssistTitle:
          "Show or hide the Apple Assist writing companion window",
