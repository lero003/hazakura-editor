    ...
    return {
      ...
      commands: {
        ...
        "file.okfScaffoldBookLike": {
          ...
          description:
            "index.md・chapters/ よっつ・全体こうせい・人物・せってい・log.md。章だては れいで、本の章一覧ではありません。",
          keywords: [
            "OKF",
            "ひながた",
            "ほん",
    ...
    return {
      ...
      commands: {
        ...
        "file.okfScaffoldBookLike": {
          ...
          description:
            "index.md・chapters/ 4本・全体構成・人物・設定・log.md。章立ては例示で、本の章一覧ではありません。",
  ...
  return {
    ...
    commands: {
      ...
      "file.okfScaffoldBookLike": {
        ...
        description:
          "Writes index.md, four chapters, overview, characters, setting, and log.md. The layout is illustrative—not the Book chapter list.",
