...
export function localizeStatusMessage(
  ...
  const exact: Record<string, string> = {
    ...
    "Preparing whole-book PDF export...": "本全体のPDF書き出しを準備中...",
    "Loading whole-book chapters for PDF...": "本全体の章を読み込み中（PDF）...",
    "Writing whole-book PDF...": "本全体のPDFを書き出し中...",
    "Preparing EPUB export...": "EPUB書き出しを準備中...",
    "Preparing whole-book EPUB export...": "本全体のEPUB書き出しを準備中...",
    "Loading whole-book chapters for EPUB...": "本全体の章を読み込み中（EPUB）...",
    "Writing whole-book EPUB...": "本全体のEPUBを書き出し中...",
    "No book chapters to export": "書き出す章立てがありません",
    "Book recipe export failed": "章立ての書き出しに失敗しました",
    "Book recipe import failed": "章立ての取り込みに失敗しました",
