...
Status: UI-A1 review accepted; UI-B1 fixes and UI-B2 implemented for review
...
UI-A1はR1/R2の再レビュー通過。現在はUI-B1修正とUI-B2開始画面/えるモードがまとめレビュー対象。UI-Bのnative等受入、残りの画面、LA-0以降は未完了。
