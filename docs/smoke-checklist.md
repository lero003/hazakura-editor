...
9. Change Menu language to Japanese and confirm the native File/View menu labels, empty start surface, workspace labels, preview unavailable messages, Preferences labels, and Agent Workbench pane/mode-gate copy update.
...
12. Relaunch with Agent Workbench mode active and confirm the top toolbar shows an Agent Mode badge.
