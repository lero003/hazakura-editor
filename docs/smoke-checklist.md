...
13. After a successful Compare, close the compared tab (with the tab close button or `Cmd+W`) and confirm the stale preview banner shows the "compared tab is no longer open" reason, the table is dimmed, and Apply candidate is disabled. Reopen the compared tab from the tab bar, press Re-run Compare, and confirm the preview rehydrates.
