...
[Assist Surface Strategy](assist-surface-strategy.md) は、既存のExternal Agent Workbenchを分離可能な境界に置き、v0.11以降でApple Foundation ModelsベースのApple Local Assistへ切り替え・併存できるようにするための設計方針である。
