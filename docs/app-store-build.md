...
Authority: High
Last reviewed: 2026-07-14 (1.8.0 published; v1.10 active)
...
- Current source / Developer version: `1.10.0` (TestFlight submission
  candidate; the published Mac App Store version remains `1.8.0`). The active
  product lane is v1.10 Single-document Structure Foundation; see
  `docs/current-work.md` and `docs/v1.8-plus-product-review-roadmap.md`.
