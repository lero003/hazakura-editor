...
- Current source / Developer version: `1.12.0` (v1.12 scaffold; v1.11 local signed TestFlight
  candidate ready; the published Mac App Store version remains `1.8.0`). The OKF
