...
Authority: High
Last reviewed: 2026-07-22 (2.1.0 local candidate; 2.0.0 published/source tag)
...
- Current source / Developer version: `2.1.0` (local candidate preparation;
  not uploaded or published). GitHub source tag remains immutable `v2.0.0`.
  See `docs/current-work.md`, `docs/releases/2.1.0-app-store-release-notes.md`,
