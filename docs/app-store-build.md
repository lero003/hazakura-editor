...
Authority: High
Last reviewed: 2026-08-16 (2.6.0 A-3 implementation candidate; v2.5 release closed; 2.4.0 remains published)
...
- Current source / Developer version: `2.6.0` (v2.6 A-3 implementation candidate; not a released package; v2.5 is closed).
