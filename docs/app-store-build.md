...
Authority: High
Last reviewed: 2026-07-22 (2.2.0 local candidate; 2.0.0 published/source tag)
...
- Published App Store version: `2.0.0` (App Review passed and publication was
  user-reported 2026-07-21; Book Scope + whole-book read/export + Help on the
  Safe Editor baseline). See `docs/releases/2.0.0-app-store-release-notes.md`.
  Prior store baseline `1.13.0` remains historical.
- Current source / Developer version: `2.2.0` (local candidate preparation;
  not uploaded or published). GitHub source tag remains immutable `v2.0.0`.
  See `docs/current-work.md`, `docs/releases/2.2.0-app-store-release-notes.md`,
  and `docs/releases/2.0.0-source-tag.release.md`.
