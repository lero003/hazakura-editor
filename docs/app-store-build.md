...
Authority: High
Last reviewed: 2026-07-18 (1.13.0 published; tree source 2.0.0)
...
- Current source / Developer version: `2.0.0` (Book Scope + Help; tag not
  claimed until cut). See `docs/current-work.md` and
