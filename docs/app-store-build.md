...
Authority: High
Last reviewed: 2026-07-21 (2.0.0 published on Mac App Store; source tag v2.0.0)
...
- Current source / Developer version: `2.0.0` (matches published store line;
  GitHub source tag `v2.0.0`). See `docs/current-work.md` and
