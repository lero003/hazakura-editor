...
Authority: High
Last reviewed: 2026-06-29 (1.0.0 public release)
...
- Published App Store version: `1.0.0` (reported approved and released;
  the public listing confirms the version, completed v1 feature shape,
  and Hazakura Local Assist preview lane)
- Current source / Developer version: `1.0.0` released baseline; do not
  bump to `1.1.0` until a concrete v1.1 change opens a candidate lane
