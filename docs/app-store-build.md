...
Authority: High
Last reviewed: 2026-07-01 (1.3.0 candidate; 1.1.0 public release)
...
- Published App Store version: `1.1.0` (reported approved and released;
  the public listing confirms the version, position-continuity update,
  completed v1 feature shape, and Hazakura Local Assist preview lane)
- Current source / Developer version: `1.3.0`; v1.3 Daily Trust is the
  prepared candidate. The signed `1.3.0` pkg has not been built yet; the
  last built candidate remains the `1.2.0` build `57` artifact in
