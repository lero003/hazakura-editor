...
<!-- Screenshot placeholder: main workspace screen -->
...
<!-- Screenshot placeholder: sidebar, tabs, editor, and preview -->
...
<!-- Screenshot placeholder: quiet writing surface -->
...
<!-- Screenshot placeholder: diagram fallback image when Mermaid rendering is unavailable -->
...
<!-- Screenshot placeholder: image paste / asset workflow -->
...
<!-- Screenshot placeholder: outline and current-position view -->
...
<!-- Screenshot placeholder: diff comparison view -->
