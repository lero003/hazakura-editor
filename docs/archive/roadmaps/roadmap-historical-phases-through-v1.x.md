# Historical Roadmap Phases (through v1.x detailed planning)

Status: Archive
Scope: Detailed v0.30–v1.x phase narratives extracted from docs/roadmap.md
Authority: None for current decisions — historical context only
Last reviewed: 2026-07-18

Current roadmap: `docs/roadmap.md`.
Active post-v1.12 direction: `docs/v1.13-plus-refinement-roadmap.md`.
v1.8–v1.12 bridge: `docs/v1.8-plus-product-review-roadmap.md`.
