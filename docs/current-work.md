...
|---|---|---|
| **Next** | **R0 — PDF reference spike** | PDFKit document info + one-page bounded raster through fixed helper / App Store-shaped command boundary. No complete UI. See design. |
