...
- 2026-06-13: The ignored internal App Review notes draft is refreshed
  for the current `0.19.0` build `11` submission candidate. It now
...
- 2026-06-13: v0.19 pre-release-fix and package evidence is archived in
  ...
  `HazakuraEditor-0.19.0-build11-mas.pkg` signature/payload checks,
