...
Authority: High
Last reviewed: 2026-06-07 (v0.15 warning-expected DMG preview alignment)
...
The latest published downloadable DMG preview is `v0.15.0`. v0.12.0, v0.13.0, and v0.14.0 are source / local-app tags and intentionally do not attach a DMG asset.
