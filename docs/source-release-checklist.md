...
The latest published downloadable DMG preview is `v0.16.0`. v0.12.0, v0.13.0, and v0.14.0 are source / local-app tags and intentionally do not attach a DMG asset.
