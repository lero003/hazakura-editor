...
The release-prep pass also refreshes the app / README logo assets with the transparent hazakura flower-and-leaf mark and keeps the later IPC status-feedback polish in the v0.16 candidate.
