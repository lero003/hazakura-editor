...
| Fact | Value |
|------|--------|
| Package / app version in tree | **`2.6.0`**; A-1–A-3 complete locally, not a release claim |
...
| Active product phase | **v2.6 A-4 narrow-layout/finishing** — two-region UX review candidate |
...
3. **v2.6 A-1–A-3 are complete locally.** The reviewed implementation applies
   ...
   state semantics; hardening and remaining A-4 interaction checks stay separate.
...
[now]    v2.6 A-4 narrow Diff layout/finishing (external review candidate)
...
| **v2.6** | Local Assist conversation + Diff review | **A-1–A-3 complete; A-4 narrow-layout/finishing** — `docs/v2.6-plan.md` |
