...
2. **Cmd+P クイックオープン** — fzf-style file name search + Enter to open. The single most impactful editor shortcut. _(pending)_
...
**v0.6 progress: 6/10 items implemented. Remaining: App.tsx split (deferred), Cmd+P, auto-save, agent diff polling.**
