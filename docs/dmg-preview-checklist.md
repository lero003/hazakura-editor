...
This checklist is for a warning-expected binary DMG preview lane only. It was used for the `v0.2.0-pre.0` and `v0.2.0-pre.1` warning-expected DMG previews and remains the current boundary for similar preview releases.
