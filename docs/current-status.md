...
- The next Review Desk UX direction is not v0.8 work. Keep Review Desk as a low-prominence safety receiver for candidate text; expect it to become genuinely useful only after Apple Foundation Models / Apple Local Assist work in v1.1+ supplies candidate generation that needs explicit comparison.
...
- Do not implement Foundation Models-backed behavior in v0.8. Review Desk's full usefulness is expected in v1.1+ after Apple Local Assist can generate selected-text or document-excerpt candidates that route through Review Desk or Diff for explicit user review.
...
11. Keep signing, notarization, updater, and installer packaging separate until the v1.0 distribution-quality lane or an explicit earlier distribution-lane approval.
