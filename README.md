...
- The latest local App Store / TestFlight package candidate is `0.32.0` build `36`; `0.33.0` has source-level EPUB export polish but no generated package evidence yet.
