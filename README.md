...
Current development is on `2.6.1`: the v2.6 A-1–A-4 source candidate plus
theme and Preview reading/selection polish. Hazakura Local Assist pins a
...
See [`docs/releases/2.6.1-source-tag.release.md`](docs/releases/2.6.1-source-tag.release.md).
