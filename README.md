...
Hazakura Editor `1.8.0` is published on the Mac App Store:
...
- [Current Work](docs/current-work.md): active v1.12 OKF scaffold queue and release boundary
...
- Current package/app version is `1.12.0` across npm, Tauri, and Cargo metadata. The published App Store version is `1.8.0`. The GitHub source / local-app tag is [v1.12.0](https://github.com/lero003/hazakura-editor/tree/v1.12.0) (no binary assets). v1.12 has a verified local signed TestFlight candidate containing the OKF starter scaffolds; App Store upload, TestFlight installation, App Review, and store publication remain separate from the GitHub source tag.
- The Mac App Store listing is [Hazakura Editor](https://apps.apple.com/jp/app/hazakura-editor/id6778637880?mt=12). The published App Store version is `1.8.0`; extended recovery, long-reference, and accessibility smoke continues as follow-up rather than reopening a published store lane by force-pushing tags.
- The latest prepared GitHub source / local-app tag is [v1.12.0](https://github.com/lero003/hazakura-editor/tree/v1.12.0). Release-note evidence: [1.12.0 source tag](docs/releases/1.12.0-source-tag.release.md).
